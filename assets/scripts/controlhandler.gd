...
func run_handler(button1text, button2text, button3text, button4text, button1, button2, button3, button4, start_dialog_id, current_dialog_id, options, gameover_screen ):
	hide_buttons()
	print("GOYDA ГОЙДА")
