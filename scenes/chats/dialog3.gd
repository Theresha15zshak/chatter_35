...
var dialog_json = {
  ...
  "what": {
	...
	"options": {
	  ...
	  "Не помню такого. Возможно, вы ошиблись.": {"var": "end_bad", "chance": 100, "endF":"Вы остались без еды."}
	}
  },
  "where": {
	...
	"options": {
	  ...
	  "Попробуйте найти дорогу к 5-му дому через карту. (Риск)": {"var": "risk_path", "chance": 36, "endF":"Курьер не нашел путь к вам"}
	}
  },
  "searching": {
  ...
  "wrong_way": {
	...
	"options": {
	  ...
	  "Попробуйте найти кого-то для помощи.": {"var": "end_bad", "chance": 100, "endF":"Курьер заблудился и теперь вы останитесь без еды"}
	}
  },
  "lost": {
	...
	"options": {
	  ...
	  "Ну сделайте ,что нибудь": {"var": "end_bad", "chance": 100,"endF":"Курьер заблудился и теперь вы останитесь без еды"}
	}
  },
  "searching2": {
  ...
  "finded_path": {
	...
	"options": {
	  "Отлично, жду вас!": {"var": "end_good", "chance": 100, "end":"Скоро прибудет ваша вкусная еда"}
	}
  },
}
