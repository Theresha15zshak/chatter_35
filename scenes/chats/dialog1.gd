...
var dialog_json = {
	...
	"options": {
	  ...
	  "Не приближатся к криперу": {"var":"end_bad", "chance":100},
	  "Не срубать первый блок дерева": {"var":"end_bad", "chance":100},
	}
	},
	"start_2": {
	"text": "Какой самый редкий ресурс в майнкрафте?",
	"options": {
	  "Рудное золото": {"var":"end_bad", "chance":100},
	  "Алмазы": {"var":"end_bad", "chance":100},
	  "Незеритовые обломки": {"var":"end_bad", "chance":100},
	...
	"options": {
	  ...
	  "Золотая": {"var":"end_bad", "chance":100},
	}
	},
	"start_4": {
	"text": "Какой самый опасный моб майнкрафта",
	"options": {
	  "Зомби": {"var":"end_bad", "chance":100},
	  "Камень": {"var":"end_bad", "chance":100},
	  "Чешуйница": {"var":"start_5", "chance":100},
	  "Кошка": {"var":"end_bad", "chance":100},
	}
	},
	"start_5": {
	...
	"options": {
	  ...
	  "Дракон": {"var":"end_bad", "chance":100},
	  "Крипер": {"var":"end_bad", "chance":100},
	}
	},
	"start_6": {
	"text": "Финальный вопрос. По какому блоку можно прыгать?",
	"options": {
	  "Слизневый блок": {"var":"end_good", "chance":100},
	  "Медовый блок": {"var":"end_bad", "chance":100},
	  "Полублок": {"var":"end_bad", "chance":100},
	}
	},
}
