...
var dialog_json = {
	"start": {
		...
		"options": [
			{"text": "Вот берите (Отдать кошелек и телефон)", "params": {"next": "give", "chance": 100}},
			{"text": "Попробуй догони меня (Убежать)", "params": {"next": "run", "chance": 100}},
			{"text": "Давай попробуй! (Дать бой)", "params": {"next": "fight", "chance": 100}},
			{"text": "Тебе не стоит меня грабить", "params": {"next": "talk", "chance": 100}}
		]
	},
	"give": {
		"text": ["Вали отсюда теперь"],
		"options": [
			{"text": "Ухожу!", "params": {"next": "end_bad1", "chance": 100}}
		]
	},
	"run": {
		"text": ["Эй, а ну иди сюда!"],
		"options": [
			{"text": "Бежать дальше (Риск)", "params": {"next": "end_good1", "chance": 50, "end": "У вас получилось убежать", "endF": "Бандит вас догнал"}},
			{"text": "Бандит догоняет вас и угрожает (Риск)", "params": {"next": "caught", "chance": 100}}
		]
	},
	"caught": {
		"text": ["Попался! Теперь ты у меня заплачешь, жмур. А ну ка давай вещи, а то дам по лицу."],
		"options": [
			{"text": "Отдать кошелек и телефон", "params": {"next": "give", "chance": 100}},
			{"text": "(Попытаться выбраться и снова убежать)", "params": {"next": "run_again", "chance": 99}}
		]
	},
	"run_again": {
		"text": ["Ну все, доигрался, теперь ты труп!"],
		"options": [
			{"text": "(Попробовать убежать)", "params": {"next": "end_bad2", "chance": 25, "end": "У вас получилось убежать", "endF": "Бандит вас догнал"}}
		]
	},
	"fight": {
		"text": ["Сейчас ты заплачешь у меня!"],
		"options": [
			{"text": "(Драться с бандитом риск)", "params": {"next": "end_good2", "chance": 25, "end": "У вас получилось победить бандита в бою", "endF": "Бандиту получилось вас победить"}}
		]
	},
	"talk": {
		"text": ["Да? А с чего это?"],
		"options": [
			{"text": "Тут везде полиция, я на тебя доложу и тебя сразу же посадят. Если убьешь, то сядешь на всю жизнь", "params": {"next": "talk_success", "chance": 30}},
			{"text": "У меня крыша из твоих братков, Юра меня крышует", "params": {"next": "end_good3", "chance": 30, "end": "Бандит испугался вашей крыши и теперь вы в безопасности", "endF": "Бандит не поверил вам"}},
			{"text": "У меня крыша из твоих братков, Андрюха меня крышует", "params": {"next": "end_good3", "chance": 100, "end": "Бандит испугался вашей крыши и теперь вы в безопасности"}}
		]
	},
	"talk_success": {
		"text": ["Наверное ты прав, давай вали отсюда."],
		"options": [
			{"text": "(Убежать)", "params": {"next": "end_good4", "chance": 100, "end": "Вы смогли убедить бандита, что ему не стоит вас грабить"}}
		]
	},
	"end_bad1": {
		"text": ["Хахаха "],
	...
	"end_bad2": {
		"text": ["На тебе по бочине. Теперь ты жмур"],
		"options": [],
		"end_type": "lose"
	},
	"end_good1": {
		"text": ["Э , ты куда убежал?"],
		"options": [],
		"end_type": "win"
	},
	"end_good2": {
		"text": ["Ай, сдаюсь сдаюсь"],
		"options": [],
		"end_type": "win"
	},
	"end_good3": {
		"text": ["Хм, ну ты прав иди отсюда "],
		"options": [],
		"end_type": "win"
	},
	"end_good4": {
		"text": ["Давай быстро вали"],
		"options": [],
		"end_type": "win"
	}
}
